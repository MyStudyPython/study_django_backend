...
class RevisionView(BaseRevisionView):
    ...
    def post_response(self):
        self.message_user(
            ...
            % {
                "model": force_str(self.opts.verbose_name),
                "name": smart_str(self.new_obj),
            },
            "success",
        )
    ...
    def get_related_versions(self, obj, version, formset):
        ...
        related_versions = dict(
            [
                ...
                == formset.model
                and smart_str(related_version.field_dict[fk_name])
                == smart_str(object_id)
            ]
        )
